...
function ApplicationForm({ jobTitle }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { error: supabaseError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("applications").insert([
                applicationData
            ]);
            if (supabaseError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__911b507b._.js.map